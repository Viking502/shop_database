...
ALTER TABLE Attachment ADD CONSTRAINT Attachment_PK PRIMARY KEY CLUSTERED (id, Message_id, Message_Conversation_id, Message_Conversation_User_id, Message_User_id)
     WITH (
     ALLOW_PAGE_LOCKS = ON , 
     ALLOW_ROW_LOCKS = ON )
GO
...
ALTER TABLE Conversation ADD CONSTRAINT Conversation_PK PRIMARY KEY CLUSTERED (id, User_id)
     WITH (
     ALLOW_PAGE_LOCKS = ON , 
     ALLOW_ROW_LOCKS = ON )
GO
...
ALTER TABLE Message ADD CONSTRAINT Message_PK PRIMARY KEY CLUSTERED (id, Conversation_id, Conversation_User_id, User_id)
     WITH (
     ALLOW_PAGE_LOCKS = ON , 
     ALLOW_ROW_LOCKS = ON )
GO
